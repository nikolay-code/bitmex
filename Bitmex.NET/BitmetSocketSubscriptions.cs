...
namespace Bitmex.NET
{
    public static class BitmetSocketSubscriptions
    {
        ...
        {
            return BitmexApiSubscriptionInfo<IEnumerable<OrderBook10Dto>>.Create(SubscriptionType.orderBook10, act).WithArgs("XBTUSD");
        }
        ...
        {
            return BitmexApiSubscriptionInfo<IEnumerable<TradeBucketedDto>>.Create(SubscriptionType.tradeBin1m, act).WithArgs("XBTUSD");
        }
        ...
        {
            return BitmexApiSubscriptionInfo<IEnumerable<TradeBucketedDto>>.Create(SubscriptionType.tradeBin1h, act).WithArgs("XBTUSD");
        }

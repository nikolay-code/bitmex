...
namespace MachinaTrader.Indicators
{
    public static partial class Extensions
    {
        public static List<decimal?> Rsi(this List<Candle> source, int period = 14)
        {
            ...
            var ema = TicTacTec.TA.Library.Core.Rsi(0, source.Count - 1, closes, period, out int outBegIdx, out int outNbElement, rsiValues);
        ...
        public static List<decimal?> Rsi(this List<decimal> source, int period = 14)
        {
            ...
            var ema = TicTacTec.TA.Library.Core.Rsi(0, source.Count - 1, sourceFix, period, out int outBegIdx, out int outNbElement, rsiValues);
